...
public class GameManager {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Target is " + target.getRow() + "" + target.getColumn());
        System.out.println("it's occupied: " + target.isOccupied());
        if (gm.movementManager.isMoveable(rook, target))
            System.out.println("The rook CAN move to " + target.getRow() + target.getColumn());
        else
        ...
        /*
        Square target = gm.board.getSquareAtLoc(1, 'A');
        System.out.println("Target is " + target.getRow() + "" + target.getColumn());
        System.out.println("it's occupied: " + target.isOccupied());
        if (gm.movementManager.isMoveable(bishop, target))
            System.out.println("The bishop CAN move to " + target.getRow() + target.getColumn());
        else
            System.out.println("It can't");
            */
