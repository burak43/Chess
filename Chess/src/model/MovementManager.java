	...
	public boolean addPiece(Piece piece) {
		...
		if (piece instanceof Pawn) {
			if (((Pawn) piece).isPromoted()) {
				...
				/*
				 * Here pawn still remains in the pieceSet of the player. Even
				 * worse, you do not add the new piece, which is a queen, to the
				 * peiceSet of the player. It may or may not cause a problem !!!
				 */
